...
/**
 * <p>
 * Class to directly handle running CRUD operations against the PLAYER table.
 * </p>
 * <p>
 * All methods that require a {@link Connection} object to function should be
 * passed the object by the associated
 * {@link com.stuart.tourny.controller.PlayerController} class. Similarly no
 * commits/rollbacks should occur in this class - all transaction management is
 * the responsibility of the
 * {@link com.stuart.tourny.controller.PlayerController}.
 * </p>
 */
public class PlayerDbEngine {
     ...
     */
    public DTOPlayer getPlayer(final Connection conn, final KeyPlayer key) throws SQLException {
	DTOPlayer dto = null;
    ...
    /**
     * Add a new player record to the database. This will return an updated DTO
     * back as a result.
     *
     * @param conn
     *            - The connection to the database
     ...
     */
    public DTOPlayer addPlayer(final Connection conn, final DTOPlayer dto) throws SQLException {
     ...
     *            - Record to delete
     */
    public void deletePlayer(final Connection conn, final DTOPlayer dto) throws SQLException {
    ...
    /**
     * Convert a ResultSet into a DTOPlayer (including creating and setting the
     * RowHash
     */
    private static DTOPlayer getDTOFromResultSet(final ResultSet rs) throws SQLException {
