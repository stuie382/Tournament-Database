...
public class ConnectionManager {
     ...
     * {@code getInstance} method is run. That will create the connection pool
     * manager connected to the embedded Derby instance.
     */
    ...
    /**
     * Get an instance of this connection manager. Will create a new one if it
    ...
    /**
     * Get a connection from the pool for the specified schema, with auto commit
     * disabled.
     *
